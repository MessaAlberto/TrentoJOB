...
const emailVerificationRejected = (who) => {
    return `<!DOCTYPE html>
    <html>
    <head>
        <meta charset="UTF-8">
    ...
    <div class="container">
        ...
        <div class="content">
            <p>Hi ${who},</p>
            <p>We regret to inform you that your account verification has been rejected. If you have any questions, please contact our support team.</p>
        </div>
        <div class="footer">
            <p>&copy; 2024 Your Company. All rights reserved.</p>
        </div>
